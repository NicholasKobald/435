...
# copy IR files over
scp -r $ir_input_file linux.csc.uvic.ca:/home/$username/compiler-construction/compiler/project/stage/$ir_input_file

# log into remote server to run commands
ssh linux.csc.uvic.ca /bin/bash << RUNTHESEBOYS
